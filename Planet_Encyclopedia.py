...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_gravity_radius['text'] = "Gravity : 3.7 meter per second square /n Radius : 2,439.7 km"
        ...
        label_planet_gravity_radius['text'] = "Gravity : 9.807 meter per second square /n Radius : 6,051 km"
        label_planet_info['text'] = " Venus is the brightest object in the sky after the Sun and the Moon, and sometimes looks like a brigt star in the morning or evening sky."
    elif planet == "Earth":
        label_planet_name['text'] = "Earth"
        label_planet_image['image'] = Earth
        label_planet_gravity_radius['text'] = "Gravity : 8.87 meter per second square /n Radius : 6,371 km"
